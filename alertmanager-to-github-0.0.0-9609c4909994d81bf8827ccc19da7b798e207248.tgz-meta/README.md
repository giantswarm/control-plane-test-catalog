...
# alertmanager-to-github chart

Giant Swarm offers a alertmanager-to-github App which can be installed in workload clusters.
Here, we define the alertmanager-to-github chart with its templates and default configuration.
