...
The silence operator to manage [alertmanager](https://github.com/prometheus/alertmanager) [silences](https://prometheus.io/docs/alerting/latest/alertmanager/#silences).
...
The `silence-operator` is under the Apache 2.0 license. See the [LICENSE](LICENSE) file for details.
