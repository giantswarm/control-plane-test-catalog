...
Giant Swarm offers a k6-operator App which can be installed in workload clusters.
Here, we define the k6-operator chart with its templates and default configuration.
